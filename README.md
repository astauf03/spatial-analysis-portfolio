...
|-----------|---------------------|
| **Spatial Analysis** | Spatial Join, Buffer, Clip, Hot Spot Analysis (Gi*), Local Moran’s I, Kernel Density Estimation |
| **Geoprocessing** | ModelBuilder workflows, batch processing, field calculations, overlay operations |
| **Data Management** | Feature class editing, joins and relates, field schema design |
| **Visualization** | ArcGIS Pro map layouts, ArcGIS Online dashboards, StoryMaps |
| **Scripting (in progress)** | ArcPy and Python for automating spatial analysis tasks |
